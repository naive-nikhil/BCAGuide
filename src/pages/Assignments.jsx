...
const generatePapers = () => ({
  session: {
    june: Array.from({ length: 10 }, (_, i) => ({
      year: `June ${2011 + i}`,
      link: "https://res.cloudinary.com/dinzuxodt/image/upload/BCS-012-June2012_tvwdh8.pdf",
    })),
    december: Array.from({ length: 10 }, (_, i) => ({
      year: `December ${2011 + i}`,
      link: "#",
    })),
  },
});
...
const Assignments = () => {
  ...
  return (
    <div className="overflow-hidden">
      <h1 className="text-xl text-text-primary mb-4">Assignments</h1>
        ...
        <div className="flex text-text-primary max-h-[calc(374px)] border border-gray-200 rounded-md overflow-hidden">
          ...
          <div className="flex-1 bg-white">
            ...
            >
              ...
              <div className="relative w-full h-92 p-5 [&_h2]:cursor-pointer">
                <button
                ...
                <div className="flex items-center justify-between p-3 border border-gray-200 rounded border-b-3 cursor-pointer mb-4">
                  <div>
                    ...
                    <p className=" text-text-primary/60">
                      Assignments are organised session wise (June & December)
                    </p>
                  </div>
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {selectedCourse &&
                    selectedCourse.papers?.session?.[selectedSession]?.map(
                      (item, index) => (
                        <li
              ...
              <div className="relative w-full h-full p-5 [&_h2]:cursor-pointer flex justify-between gap-4">
                <div className="w-full flex flex-col justify-between">
                  ...
                  <div>
                    ...
                    <h3>Assignment- {selectedYear}</h3>

                    <div className="flex w-full gap-1 mt-4">
                      <button
                        className={`w-full rounded py-2 cursor-pointer bg-blue-200 mt-2 hover:-translate-y-1 transition duration-300 ease-in-out text-blue-600`}
                      >
                        Download Paper
                      </button>
                      <br />
